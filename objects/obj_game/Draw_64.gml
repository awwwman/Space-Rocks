switch(room) {
	case rm_space:
		...
		draw_text_transformed_color(global.cameraWidth/2, 325, "DOUBLE POINTS!", 1, 1, 0, c, c, c, c, min(1, alarm[1]/60));
		draw_text_transformed_color(global.cameraWidth/2, 350, "REFLECT!", 1, 1, 0, c, c, c, c, min(1, alarm[2]/60));
		draw_text_transformed_color(global.cameraWidth/2, 50, "NUKE!", 1, 1, 0, c, c, c, c, min(1, alarm[3]/60));
		draw_text_transformed_color(global.cameraWidth/2, 375, "EXTRA LIFE!", 1, 1, 0, c, c, c, c, min(1, alarm[4]/60));
